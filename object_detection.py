...
def detect_objects(image_path, prompts):
...
# def mock_call_api_func(messages, class_type):
#     return '{"objects": [{"object_name": "Chair A", "spatial_relationship_with_user": "near"}], "scene_type": "office"}'
...
result = detect_objects(image_path, prompts)
print(result)
import os
from pydantic import BaseModel
from typing import List
